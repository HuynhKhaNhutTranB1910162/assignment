            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumb__text">
                        ...
                        <div class="breadcrumb__links" style="margin-left: 250px">
                            <a href="{{ route('order.history') }}">Tất cả đơn hàng</a>
                            <a href="{{ route('order.history.pending') }}">Đang chờ duyệt</a>
                            <a href="{{ route('order.history.accepted') }}">Đã được duyệt</a>
                            <a href="{{ route('order.history.inDelivery') }}">Đang vận chuyển</a>
                            <a href="{{ route('order.history.success') }}">Thành công</a>
                            <a href="{{ route('order.history.cancel') }}">Hủy bỏ</a>
                        </div>
                    </div>
                </div>
            </div>
